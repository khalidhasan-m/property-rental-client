...
export function Footer() {
    return (<footer className="mt-auto border-t border-[var(--line)] bg-[var(--surface)]">
      <div className="mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8 grid gap-10 py-12 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
      ...
      <div className="border-t border-[var(--line)]"><div className="mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8 py-5 text-xs text-[var(--muted)]">© {new Date().getFullYear()} Nestora. Built for better rental decisions.</div></div>
    </footer>);
}
