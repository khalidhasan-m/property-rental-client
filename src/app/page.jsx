...
const benefits = [
  {
    icon: ShieldCheck,
    title: "100% Moderated Listings",
    text: "Every property is thoroughly reviewed by administrators before being listed publicly.",
  },
  {
    icon: HeartHandshake,
    title: "Seamless Booking Requests",
    text: "Submit booking requests and track payment approvals from your personal dashboard.",
  },
  {
    icon: Building2,
    title: "Transparent Pricing",
    text: "No hidden fees. Pay reservation deposits securely through Stripe-powered checkout.",
  },
];
...
const defaultLocations = [
  {
    name: "Dhaka",
    properties: 42,
    image: "/locations/dhaka.jpg",
  },
  {
    name: "Chittagong",
    properties: 28,
    image: "/locations/chittagong.jpg",
  },
  {
    name: "Sylhet",
    properties: 15,
    image: "/locations/sylhet.jpg",
  },
  {
    name: "Rajshahi",
    properties: 11,
    image: "/locations/rajshahi.jpg",
  },
];
...
function SectionHeader({ badge, title, subtitle, center = false }) {
  return (
    <div className={center ? "text-center" : ""}>
      <span className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.14em] text-[var(--brand)]">
        {badge}
      </span>
...
const CITY_IMAGES = {
  ...
  "cox's bazar":
    "https://images.unsplash.com/photo-1623910271383-6f81fc7603c6?auto=format&fit=crop&w=600&q=80",

  bangladesh:
    "https://images.unsplash.com/photo-1604993497451-eed6eb271a9c?q=80&w=1074&auto=format&fit=crop",

  "new york":
    "https://images.unsplash.com/photo-_QdFx92MO2U?auto=format&fit=crop&w=800&q=80",
};
...
export default function Home() {
        ...
        if (data?.data?.length) {
          const dynamicLocations = data.data.map((loc, i) => {
            ...
            return {
              ...
              image:
                knownImage ||
                defaultLocations[i % defaultLocations.length].image,
            };
          });
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[650px] overflow-hidden py-20 text-white sm:py-28 lg:py-32">
        {/* Background Image */}
        <Image
        ...
        <div className="relative mx-auto grid w-full max-w-[1180px] items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_.9fr] lg:px-8">
          {/* LEFT CONTENT */}
          <motion.div
            initial={{
              opacity: 0,
          ...
          >
            ...
            <h1 className="max-w-3xl text-4xl font-black leading-[1.05] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              Find your next home{" "}
              <em className="font-serif italic font-normal text-amber-200">
            ...
            >
              Discover handpicked, moderated rental properties with transparent
              pricing, instant booking requests, and direct owner management.
            </motion.p>
            ...
            >
              <span className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-3.5 py-2 backdrop-blur-md">
          ...
          >
            ...
            <div className="grid gap-4">
              <Input
                ...
                startContent={
                  <MapPinned size={18} className="text-[var(--brand)]" />
                }
              />
              ...
              <Select
                ...
                onSelectionChange={(keys) =>
                  setPropertyType(Array.from(keys)[0] || "all")
                }
              >
              ...
              <Button
                onPress={search}
                size="lg"
                className="mt-2 h-12 w-full rounded-2xl bg-gradient-to-r from-emerald-800 to-emerald-700 font-black text-white shadow-lg shadow-emerald-950/30 transition-all hover:shadow-xl"
              >
                <Search size={18} />
                Search Properties
              </Button>
      ...
      <section className="border-b border-emerald-950 bg-emerald-900 py-5">
          ...
          <div className="flex flex-col items-center justify-between gap-4 divide-y divide-emerald-700/50 md:flex-row md:divide-x md:divide-y-0">
            {rentalStats.map((stat, i) => (
              <FadeInSection
                key={stat.label}
                delay={i * 0.1}
                className="flex w-full justify-center py-2 md:py-0"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col items-start leading-[1.2]">
                    ...
                    <span className="text-[13px] font-medium text-emerald-200/90">
                      {stat.label}
                    </span>
                  </div>
                </div>
        ...
        <FadeInSection>
          <div className="mb-10 flex flex-wrap items-end justify-between gap-5">
            <SectionHeader
              ...
              subtitle="Freshly approved places with the detail and context you need to make a confident choice."
            />

            <Link
              href="/properties"
              className="inline-flex items-center gap-2 text-sm font-black text-[var(--brand)] transition-all hover:gap-3"
            >
        ...
        {isLoading ? (
          ...
          <div className="rounded-3xl border border-dashed border-[var(--line)] bg-[var(--surface)] p-10 text-center">
            <p className="font-bold">
              Featured properties will appear here once they are approved.
            </p>

            <Link
              className="mt-3 inline-block text-sm font-bold text-[var(--brand)]"
              href="/register"
            >
        ...
        <div className="mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8">
          <FadeInSection>
            <div className="mb-10 flex flex-wrap items-end justify-between gap-5">
              <SectionHeader
                ...
                title="Top locations"
                subtitle="Search rentals in the most popular cities across the country."
              />
          ...
          {locationsLoading ? (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {(() => {
                const filtered = topLocations.filter(
                  (loc) => !["or", "sc"].includes(loc.name.toLowerCase()),
                );
                  ...
                  >
                    ...
                    >
                      <Image
                        src={
                          loc.image ||
                          CITY_IMAGES[loc.name.toLowerCase()] ||
                          "/locations/placeholder.jpg"
                        }
                        alt={loc.name}
                        fill
                        sizes="300px"
            ...
            <SectionHeader
              ...
              title={
                <>
                  <Clock
                    size={28}
                    className="mr-2 inline text-[var(--brand)]"
                  />
                  Recently Added
                </>
              }
              subtitle="Hot off the press — newly approved listings you won't want to miss."
            />
          ...
          <FadeInSection>
            <div className="mb-12 text-center">
              <SectionHeader
                ...
                subtitle="Genuine reviews from people who found their home through Nestora."
              />
            </div>
          </FadeInSection>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {reviews.map((rev, i) => (
                <motion.div
                  ...
                  className="flex flex-col rounded-3xl border border-[var(--line)] bg-[var(--background)] p-6 shadow-xs transition-all hover:shadow-lg"
                >
                  ...
                  <p className="flex-1 text-sm italic leading-7 text-[var(--muted)]">
                    "{rev.comment}"
                  </p>
                  ...
                  <div className="mt-5 flex items-center gap-3 border-t border-[var(--line)] pt-4">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-sm font-bold">
                        {rev.user?.name || "Tenant"}
                      </p>

                      <p className="text-xs text-[var(--muted)]">
                        {rev.propertyTitle || "Nestora property"}
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              {[
                {
                  ...
                  rating: 5,
                  comment:
                    "Found my perfect apartment in Dhaka within days. The booking process was incredibly smooth and transparent.",
                  property: "Mirpur 2 Apartment",
                },
                {
                  name: "Sadia Rahman",
                  rating: 5,
                  comment:
                    "As a first-time renter, I was nervous but Nestora made everything easy. The listing details were accurate.",
                  property: "Gulshan Studio",
                },
                {
                  name: "Minhaj Uddin",
                  rating: 5,
                  comment:
                    "The owner was professional and the property matched perfectly with the photos. Highly recommend!",
                  property: "Uttara House",
                },
                {
                  name: "Nusrat Jahan",
                  rating: 4,
                  comment:
                    "Excellent platform. The admin verification system means you can trust every listing you see.",
                  property: "Motijheel Office Flat",
                },
              ].map((rev, i) => (
                <motion.div
                  key={rev.name}
        ...
        <FadeInSection>
          <div className="mb-12 text-center">
            <SectionHeader
              ...
              subtitle="Meet some of our top-rated owners who consistently deliver excellent rental experiences."
            />
          </div>
        </FadeInSection>
        ...
        {ownersLoading ? (
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {owners.map((owner, i) => (
              <motion.div
                ...
                className="flex flex-col items-center gap-4 rounded-3xl border border-[var(--line)] bg-[var(--surface)] p-7 text-center shadow-xs transition-all hover:border-[var(--brand)]/30 hover:shadow-lg"
              >
                {owner.photoURL ? (
          ...
          <div className="rounded-3xl border border-dashed border-[var(--line)] bg-[var(--surface)] p-10 text-center">
            <p className="text-[var(--muted)]">
              Trusted owners will be displayed here.
            </p>
          </div>
        )}
      </section>
        ...
        <div className="mx-auto w-full max-w-[1180px] px-4 sm:px-6 lg:px-8">
          <FadeInSection>
            <div className="max-w-2xl">
              <SectionHeader
                badge="Why Nestora"
                title="The renting experience, thoughtfully reworked."
              />
            </div>
          </FadeInSection>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            {benefits.map((item, index) => (
              ...
              >
                <div className="grid size-12 place-items-center rounded-2xl border border-[var(--brand)]/15 bg-[var(--brand-light)] text-[var(--brand)]">
                  <item.icon size={24} />
                </div>
      ...
      <section className="relative w-full overflow-hidden py-20 sm:py-24">
        ...
        <div className="pointer-events-none absolute -bottom-20 -left-40 size-[500px] rounded-full bg-teal-500/10 blur-3xl" />
        ...
        <motion.div
          ...
          className="relative mx-auto w-full max-w-[1180px] px-4 text-center text-white sm:px-6 lg:px-8"
        >
          ...
          <p className="mx-auto mt-5 max-w-xl text-emerald-200/80">
            Join thousands of happy tenants who found their home on Nestora —
            transparent, secure, and stress-free.
          </p>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/properties">
              <Button
                size="lg"
                className="h-12 rounded-2xl bg-white px-8 font-black text-emerald-900 shadow-xl transition-all hover:bg-emerald-50"
              >
                Browse Properties
                <ArrowRight size={17} />
              </Button>
            ...
            <Link href="/register">
              <Button
                size="lg"
                variant="bordered"
                className="h-12 rounded-2xl border-2 border-white/30 px-8 font-black text-white transition-all hover:bg-white/10"
              >
                Create Free Account
              </Button>
            </Link>
