...
export default function Home() {
    ...
    return (<div className="overflow-hidden">
      <section className="hero-orb relative isolate overflow-hidden py-18 text-white sm:py-24">
        ...
        <div className="container-shell relative grid items-center gap-12 lg:grid-cols-[1.08fr_.92fr]">
